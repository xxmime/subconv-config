...
port: {{ global.clash.http_port | default("7890") }}
socks-port: {{ global.clash.socks_port | default("7891") }}
allow-lan: {{ global.clash.allow_lan | default("true") }}
mode: Rule
log-level: {{ global.clash.log_level | default("info") }}
external-controller: :9090
{% if request.clash.dns | default("") == "1" %}
dns:
  enable: true
  listen: :1053
{% endif %}
...

{
    ...
    "inbounds": [
        {
            "type": "mixed",
            "tag": "mixed-in",
            {% if global.singbox.allow_lan | default("true") | bool %}
            "listen": "0.0.0.0",
            {% else %}
            "listen": "127.0.0.1",
            {% endif %}
            "listen_port": {{ global.singbox.mixed_port | default("2080") | int }}
        },
        {
            "type": "tun",
            "tag": "tun-in",
    ...
    "experimental": {
        "clash_api": {
            ...
            "external_ui": "ui",
            "secret": "",
            "external_ui_download_url": "https://tvv.tw/https://github.com/Zephyruso/zashboard/releases/latest/download/dist.zip",
